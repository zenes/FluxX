...
export default function SettingsPageClient({
    ...
    return (
        <div className="flex-1 space-y-8 p-8 pt-6">
                    ...
                    <div className="bg-card border border-input rounded-md p-6 shadow-sm">
                        ...
                        <div className="flex flex-col gap-2 font-mono text-sm">
                            ...
                            <div className="flex justify-between items-center py-4 border-b border-border/50 mt-2">
                                <span className="text-muted-foreground uppercase opacity-70">{t('settings.email')}</span>
                                <span className="font-medium">{userEmail}</span>
                            </div>
                            <div className="flex justify-between items-center py-4 border-b border-border/50">
                                <span className="text-muted-foreground uppercase opacity-70">{t('settings.role')}</span>
            ...
            {/* Danger Zone */}
            <div className="bg-card border border-destructive/20 rounded-md p-6 shadow-sm relative overflow-hidden mt-6">
