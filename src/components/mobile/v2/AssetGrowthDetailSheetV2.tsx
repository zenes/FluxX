            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed bottom-0 left-0 right-0 bg-white dark:bg-[#121214] rounded-t-[40px] shadow-2xl z-[110] max-h-[92vh] flex flex-col overflow-hidden"
                    >
                        {/* Handle Bar & Close */}
                        ...
                        <div className="overflow-y-auto hide-scrollbar">
                            ...
                            <div className="px-6 pt-10 pb-6 border-b border-zinc-100 dark:border-white/5">
                                ...
                                <div className="flex items-end justify-between">
                                    <div>
                                        <h2 className="text-2xl font-black text-[#2B364B] dark:text-white tracking-tight leading-none mb-1">
                                            총 자산 현황
                                        </h2>
                            ...
                            <div className="px-6 pb-12 pt-6 space-y-4">
