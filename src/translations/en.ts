export const en = {
    ...
    settings: {
        ...
        add_new_preset: "Add New Account Preset",
        edit_preset: "Edit Account Preset",
        update_preset: "Update Preset",
        add_preset: "Add Preset",
        no_presets_saved: "No account presets saved.",
        email: "Email",
        role: "Role",
        alias_label: "Alias (e.g. Main Trading)",
        alias_placeholder: "Alias name",
        broker_label: "Broker",
        broker_placeholder: "e.g. Kiwoom",
        account_number_label: "Account Number",
        account_number_placeholder: "123-456-***",
        owner_label: "Owner",
        owner_placeholder: "Owner name",
        profile_picture: "Profile Picture",
        profile_picture_desc: "Click the image to upload a new avatar. Maximum size is 5MB.",
